...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'safe_docente.repository.docente' => 'getSafeDocente_Repository_DocenteService',
            'safe_docente.service.docente' => 'getSafeDocente_Service_DocenteService',
            'safe_estudiante.repository.estudiante' => 'getSafeEstudiante_Repository_EstudianteService',
            'safe_estudiante.service.estudiante' => 'getSafeEstudiante_Service_EstudianteService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'safe_db', 'user' => 'safe_db_rw', 'password' => 'grupo5508', 'charset' => 'utf8mb4', 'driverOptions' => array(), 'defaultTableOptions' => array('charset' => 'utf8mb4', 'collate' => 'utf8mb4_unicode_ci')), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\AppBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Safe\\EstudianteBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\Safe\\DocenteBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'AppBundle\\Entity');
        $c->addDriver($b, 'Safe\\EstudianteBundle\\Entity');
        $c->addDriver($b, 'Safe\\DocenteBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('AppBundle' => 'AppBundle\\Entity', 'SafeEstudianteBundle' => 'Safe\\EstudianteBundle\\Entity', 'SafeDocenteBundle' => 'Safe\\DocenteBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_9730a3797cb56e254ca82da74035375b809aeef4334f8e7e49c2e5b49efcb43e');
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\swiftmailer-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'\\vendor\\doctrine\\doctrine-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'\\vendor\\sensio\\framework-extra-bundle/Resources/config/serializer'), 'FOS\\RestBundle' => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\rest-bundle\\FOS\\RestBundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'\\vendor\\jms\\serializer-bundle\\JMS\\SerializerBundle/Resources/config/serializer'), 'Nelmio\\ApiDocBundle' => ($this->targetDirs[3].'\\vendor\\nelmio\\api-doc-bundle\\Nelmio\\ApiDocBundle/Resources/config/serializer'), 'AppBundle' => ($this->targetDirs[3].'\\src\\AppBundle/Resources/config/serializer'), 'Safe\\EstudianteBundle' => ($this->targetDirs[3].'\\src\\Safe\\EstudianteBundle/Resources/config/serializer'), 'Safe\\DocenteBundle' => ($this->targetDirs[3].'\\src\\Safe\\DocenteBundle/Resources/config/serializer'), 'Symfony\\Bundle\\DebugBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\DebugBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => ($this->targetDirs[3].'\\vendor\\sensio\\distribution-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => ($this->targetDirs[3].'\\vendor\\sensio\\generator-bundle/Resources/config/serializer')));
    ...
    /**
     * Gets the 'safe_docente.repository.docente' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSafeDocente_Repository_DocenteService()
    {
        return $this->services['safe_docente.repository.docente'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('Safe\\DocenteBundle\\Entity\\Docente');
    }

    /**
     * Gets the 'safe_docente.service.docente' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Safe\DocenteBundle\Service\DocenteService A Safe\DocenteBundle\Service\DocenteService instance.
     */
    protected function getSafeDocente_Service_DocenteService()
    {
        return $this->services['safe_docente.service.docente'] = new \Safe\DocenteBundle\Service\DocenteService($this->get('safe_docente.repository.docente'));
    }

    /**
     * Gets the 'safe_estudiante.repository.estudiante' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\ORM\EntityRepository A Doctrine\ORM\EntityRepository instance.
     */
    protected function getSafeEstudiante_Repository_EstudianteService()
    {
        return $this->services['safe_estudiante.repository.estudiante'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('Safe\\EstudianteBundle\\Entity\\Estudiante');
    }

    /**
     * Gets the 'safe_estudiante.service.estudiante' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Safe\EstudianteBundle\Service\EstudianteService A Safe\EstudianteBundle\Service\EstudianteService instance.
     */
    protected function getSafeEstudiante_Service_EstudianteService()
    {
        return $this->services['safe_estudiante.service.estudiante'] = new \Safe\EstudianteBundle\Service\EstudianteService($this->get('safe_estudiante.repository.estudiante'));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Safe\\EstudianteBundle/Resources/views'), 'SafeEstudiante');
        $instance->addPath(($this->targetDirs[3].'\\src\\Safe\\DocenteBundle/Resources/views'), 'SafeDocente');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('3b98718c82ae20d8ab2887d5aa4485ffd45faea4');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5759fd2a865a68.92463006')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SafeEstudianteBundle' => 'Safe\\EstudianteBundle\\SafeEstudianteBundle',
                'SafeDocenteBundle' => 'Safe\\DocenteBundle\\SafeDocenteBundle',
            ...
            'database_port' => 3306,
            'database_name' => 'safe_db',
            'database_user' => 'safe_db_rw',
            'database_password' => 'grupo5508',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '3b98718c82ae20d8ab2887d5aa4485ffd45faea4',
            'locale' => 'en',
            ...
            'kernel.secret' => '3b98718c82ae20d8ab2887d5aa4485ffd45faea4',
