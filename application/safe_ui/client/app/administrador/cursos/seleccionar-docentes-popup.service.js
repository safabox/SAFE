(function () {
    ...
    angular
        ...
        .factory('SeleccionarDocentesPopup', factory);
    ...
    function factory($uibModal, $q) {
        ...
        function show(itemsNoSeleccionables, seleccionSimple) {
            ...
            var modalInstance = $uibModal.open({
                size: 'lg',
                templateUrl: 'app/administrador/cursos/seleccionar-docentes-popup.tpl.html',
    ...
    controller.$inject = ['$q', '_', '$scope', '$uibModalInstance', 'itemsNoSeleccionables', 'modoMultiple', 'NgTableParams', 'AdminDocentes'];

    function controller($q, _, $scope, $uibModalInstance, itemsNoSeleccionables, modoMultiple, NgTableParams, AdminDocentes) {
        var vm = this;
        ...
        function getData(params) {
            ...
            var deferred = $q.defer();
            AdminDocentes.getList().then(onSuccess, onError);
            
            return deferred.promise;

            function onError(httpResponse) {
                deferred.reject(httpResponse);
                goError('No se pueden obtener docentes', httpResponse);
            }
        ...
        function goError(errMsg, data) {
            logger.error('No se pudo guardar el Docentes');
        }
    }
})();
